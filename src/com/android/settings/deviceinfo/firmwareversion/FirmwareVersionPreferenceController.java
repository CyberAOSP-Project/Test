...
public class FirmwareVersionPreferenceController extends AbstractPreferenceController implements
    ...
    private final static String PROPERTY_CYBER_VERSION = "ro.modversion";
    private final static String PROPERTY_CYBER_RELEASE_TYPE = "ro.cyber.releasetype";
    ...
    public void displayPreference(PreferenceScreen screen) {
        ...
        if (pref != null) {
	    String version = SystemProperties.get(PROPERTY_CYBER_VERSION);
	    String releasetype = SystemProperties.get(PROPERTY_CYBER_RELEASE_TYPE).toLowerCase();
